...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scraping', '0004_auto_20191106_1700'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='vacancy',
            name='url',
            field=models.CharField(max_length=250, unique=True, verbose_name='Интернет адрес вакансии'),
        ),
        migrations.CreateModel(
            name='Url',
            fields=[
                ...
                ('speciality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraping.Specialty', verbose_name='Специальность')),
            ],
            options={
